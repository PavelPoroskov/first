...
# Functions endpoints
export FUNCTION_ENDPOINT_INTERNAL=http://localfaas:${FUNCTIONS_PORT}
export FUNCTION_ENDPOINT_EXTERNAL=http://localhost:${FUNCTIONS_PORT}
...
sudo export SQL_INTERNAL_PASSWORD="graphcool"
